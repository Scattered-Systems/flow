...
impl Server {
    ...
    pub fn socketaddr(&self) -> std::net::SocketAddr {
...
impl Settings {
    pub fn new(logger: Option<Logger>, mode: Option<Mode>, server: Option<Server>) -> Self {
        Self {
...
impl Default for Settings {
    fn default() -> Self {
        let d = Self::new(None, Mode::Development.into(), None);
